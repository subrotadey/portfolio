...
## View live demo [here](https://subrota-portfolio.netlify.app/).
...
# Usage :joystick:
### Customize your details for each component in `src/data` [folder](https://github.com/subrotadey/portfolio/tree/master/src/data).
...
>#### Set website theme in [`src/data/themeData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/themeData.js) and choose your favourite font from [`src/App.css`](https://github.com/subrotadey/portfolio/blob/master/src/App.css)

> #### About You - [`src/data/aboutData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/aboutData.js)

> #### Education details - [`src/data/educationData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/educationData.js) 

> #### Enter your Projects - [`src/data/projectsData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/projectsData.js)

> #### Add your Skills - [`src/data/skillsData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/skillsData.js)

> #### Experience - [`src/data/experienceData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/experienceData.js)

> #### Achievements - [`src/data/achievementData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/achievementData.js)

> #### Services - [`src/data/servicesData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/servicesData.js)

> #### Testimonials - [`src/data/testimonialsData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/testimonialsData.js)

> #### Your Blogs and Articles - [`src/data/blogData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/blogData.js)

> #### Contact Details - [`src/data/contactsData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/contactsData.js)

> #### Social Media Profiles - [`src/data/contactsData.js`](https://github.com/subrotadey/portfolio/blob/master/src/data/socialsData.js)
...
> ### Follow these [instructions](https://github.com/subrotadey/portfolio/wiki/Contacts) to connect contacts form with Google Sheet
...
<div>
    <table>
        <tr>
            <td align="center"><a href="https://github.com/subrotadey"><img src="https://subrotadey.github.io/car-pictures/subrota.jpg" width="135px;" height="135px;" alt=""/><br /><b>Subrota Dey</b></a></td>
